...
result = c.run(command_prefix + "sed -i 's/FMS_DB_USER=foglight/FMS_DB_USER=foglight/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB=embedded/FMS_DB=external/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_TYPE=postgresql/FMS_DB_TYPE=mysql/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_HOST=127.0.0.1/FMS_DB_HOST=10.30.152.30/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_PORT=15432/FMS_DB_PORT=3306/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_NAME=foglight/FMS_DB_NAME=autoinstalltest/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_ADMIN_USER=/FMS_DB_ADMIN_USER=admin/g' /home/test/Downloads/fms_silent_install.properties")
