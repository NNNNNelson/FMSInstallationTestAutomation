...
result = c.run(command_prefix + "sed -i 's/#FMS_DB_TYPE=postgresql/FMS_DB_TYPE=oracle/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_HOST=127.0.0.1/FMS_DB_HOST=10.30.168.79/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_PORT=15432/FMS_DB_PORT=1521/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_NAME=foglight/FMS_DB_NAME=orcl/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_ADMIN_USER=/FMS_DB_ADMIN_USER=fogdba/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/#FMS_DB_ADMIN_PASSWORD=/FMS_DB_ADMIN_PASSWORD=foglight/g' /home/test/Downloads/fms_silent_install.properties")
print("Done\n")
