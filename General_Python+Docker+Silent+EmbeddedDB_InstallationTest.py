...
command_prefix = "docker exec " + sys.argv[1] + " "
...
result = c.run(command_prefix + "wget --no-check-certificate -P /home/test/Downloads https://azrepos.labs.quest.com/rmbundles/bf73d9fd-8191-4e73-8d54-dc036a94e5ba/docs/fms_silent_install.properties")
print('Done')
...
result = c.run(command_prefix + "su test -c \'/home/test/Downloads/Foglight-5_9_5-install_linux-x86_64.bin -i silent -f /home/test/Downloads/fms_silent_install.properties\'")
...
result = c.run(command_prefix + "su test -c \'/home/test/TestInstallFMS/Foglight/bin/fms -d\'")
print('\n')
