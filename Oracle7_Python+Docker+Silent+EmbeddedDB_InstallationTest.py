...
command_prefix = "docker exec nelsonOracle7.5 "
...
result = c.run(command_prefix + "wget -P /home/test/Downloads ftp://foglight:foglight@10.30.181.125/nightly/FoglightServerDist/branches/ACE.5/5.9.5-201906271709-5cfcc59c-1198/linux-x86_64/Foglight-5_9_5-install_linux-x86_64.bin")
...
result = c.run(command_prefix + "wget -P /home/test/Downloads http://azrepos.im.labs.qsft/rmbundles/39d366d6-1519-4351-97c4-c20b36559d00/docs/fms_silent_install.properties")
print('Done')
# Download the Foglight.license to /home/test/Downloads path
information("Downloading Foglight.license file...")
result = c.run(command_prefix + "wget -P /home/test/Downloads ftp://foglight:foglight@10.30.181.125/nightly/FoglightServerDist/license/Foglight.license")
print('Done')


# MAIN_TASK--> Modify required files
# Modify the silent install properties file content to set install DIR and license file path
