...
result = c.run(command_prefix + "sed -i 's/#FMS_DB_TYPE=postgresql/FMS_DB_TYPE=sqlsvr/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_HOST=127.0.0.1/FMS_DB_HOST=10.30.152.32/g' /home/test/Downloads/fms_silent_install.properties")
result = c.run(command_prefix + "sed -i 's/FMS_DB_PORT=15432/FMS_DB_PORT=1433/g' /home/test/Downloads/fms_silent_install.properties")
...
result = c.run(command_prefix + "sed -i 's/#FMS_DB_ADMIN_USER=/FMS_DB_ADMIN_USER=sa/g' /home/test/Downloads/fms_silent_install.properties")
